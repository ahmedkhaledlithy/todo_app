  ...
  Widget build(BuildContext context) {
    return BlocConsumer<TasksCubit, TasksState>(
      ...
      builder: (context, state) {
        ...
        List<TaskModel> listOfTasks = cubit.normalTasks;
                                    ...
                                    doneFunction: (title, details) {
                                      if (formKey.currentState!.validate()) {
                                        cubit.updateToDataBase(
                                          ...
                                          status: (context.read<TaskTypeCubit>().state as ChangeTaskType).value == false
                                                  ? "normal"
                                                  : "important",
                                        );
                                      }
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                            ...
                                            child: Text(
                                              currentTask.content,
                                              style: TextStyle(fontSize: 16, color: Color(0xFF757285)),),),
                                      ],
                                    ),
                                  ),
                                  Transform.scale(
